...
vars <- c("BN.CAB.XOKA.GD.ZS", "NY.GDP.PCAP.KD.ZG")
...
FEestimate <- plm(lhs ~  BN.CAB.XOKA.GD.ZS.x + NY.GDP.PCAP.KD.ZG, data = mergedMentionsED_p, model = "between", effect = "individual")
...
FEestimate <- plm(lhs ~  BN.CAB.XOKA.GD.ZS.x + NY.GDP.PCAP.KD.ZG, data = mergedRecsED_p, model = "between", effect = "individual")
...
mergedMentionsED <- mergedMentionsED[, c("Country", "Year", "Mentions", vars)]
...
mergedRecsED <- mergedRecsED[, c("Country", "Year", "Recommendations", vars)]
...
mergedMentionsED <- mergedMentionsED[, c("Country", "Year", "Mentions", "scaled", vars)]
...
mergedRecsED <- mergedRecsED[, c("Country", "Year", "Recommendations", "scaled", vars)]
