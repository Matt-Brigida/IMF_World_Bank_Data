...
vars <- c("BN.CAB.XOKA.GD.ZS", "NY.GDP.PCAP.KD.ZG", "SL.TLF.CACT.ZS", "GC.DOD.TOTL.GD.ZS")#, "GB.XPD.RSDV.GD.ZS", )
...
We estimate the following model where:
...
# econ <- readRDS("../../../pulling_data/merged_data.rds")
